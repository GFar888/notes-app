...
const EditNotePopup = ({ showState, editNoteData }) => {
  ...
  const [newNote, setNewNote] = useState({
    ...
    body: editNoteData.body,
    createDate: new Date().getTime(),
    tag: { name: editNoteData.tag.name, color: editNoteData.tag.color },
  });
    ...
    <div className="backdrop">
      <div className="newNote" ref={popupRef}>
        ...
        <div className="newNote-footer">
          ...
          <div>
            <h2 className="cancel-btn" onClick={() => showState(false)}>
              CANCEL
            </h2>

            <h2 className="save-btn" onClick={updateNote}>
              UPDATE
            </h2>
          </div>
        </div>
